...
export default function DonatePage() {
  ...
  return (
    <div className="min-h-screen relative items-center overflow-hidden">
      <AnimatedBackground theme={theme} />
      <Navbar theme={theme} onThemeChange={cycleTheme} currentPage="donate" />

      <DonationPage theme={theme} />
